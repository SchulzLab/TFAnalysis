...
#
#arg1: The TF annotation file of the leaderboard or test data set for which TF binding should be predicted.
#arg2: Path to the folder containing the trained random forests.
