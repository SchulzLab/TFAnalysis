...
#This script rans JAMM on the DNase files contained in the input folders which must be subfolders of the specified folder.
#E.g. the specified folder is DNase_Beds. In this folder, the Bed files must be sorted into individual subfolders, e.g. DNase_Beds/HepG2_R1, DNase_Beds/HepG2_R2 and so on.
...
#arg3: Path to the chromosome size file. A suitable file is included in the repository
