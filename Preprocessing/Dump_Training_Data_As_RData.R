...
#It casts all entires to a numeric value, and replaces "." entries by 0.0.
...
if (length(args)!=2){
  print("Usage: <Path to the integrated training data files divided into subfolders> <Destination path>")
}else{
